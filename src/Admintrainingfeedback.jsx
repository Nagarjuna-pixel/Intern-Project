          ...
          <form onSubmit={handleSubmit}>
            <Grid container spacing={3}>
             ...
             <Grid item xs={12} md={6}>
                               ...
                               <Select name="trainername" fullWidth>
                                 <MenuItem value="">Select Trainer Name</MenuItem>
                                 <MenuItem value="Admin">AAA</MenuItem>
                                 <MenuItem value="Teaching">TEA</MenuItem>
                                 <MenuItem value="Nursing">NNN</MenuItem>
                                 <MenuItem value="Technical">TTT</MenuItem>
                                 <MenuItem value="Technician">TETE</MenuItem>
                               </Select>
                             </Grid>
             <Grid item xs={12} md={6}>
